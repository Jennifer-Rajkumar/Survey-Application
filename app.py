...
app.config["MAIL_USERNAME"] = 'jenn18cs030@rmkcet.ac.in'  
app.config['MAIL_PASSWORD'] = '04.07.2000'  
...
def account():
    ...
    if(re.search(regex, username)):
        ...
        if f==1:
            ...
            msg = Message('OTP',sender = 'jenn18cs030@rmkcet.ac.in', recipients = [username])  
            msg.body = 'Hi there, confirm your mail ID\n' + str(otp)
            mail.send(msg)  
